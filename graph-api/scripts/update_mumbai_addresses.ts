console.log('Updating mumbai addresses...')
const fs = require('fs')
...
networks.mumbai.Organization.address = org.address
networks.mumbai.Treasury.address = treasury.address
networks.mumbai.ActionContract.address = action.address
networks.mumbai.TaskStorageContract.address = taskStorage.address
networks.mumbai.TeamContract.address = team.address
networks.mumbai.TokenContract.address = token.address
networks.mumbai.TaskContract.address = task.address
...
console.log('Updated mumbai addresses successfully!')
