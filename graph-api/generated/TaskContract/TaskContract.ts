...
export class TaskContract extends ethereum.SmartContract {
  ...
  getTaskCount(orgId: BigInt, pending: boolean, closed: boolean): BigInt {
    let result = super.call(
      "getTaskCount",
      "getTaskCount(uint256,bool,bool):(uint256)",
      [
        ethereum.Value.fromUnsignedBigInt(orgId),
        ethereum.Value.fromBoolean(pending),
        ethereum.Value.fromBoolean(closed)
      ]
    );
  ...
  assignSelf(taskId: BigInt): i32 {
    let result = super.call("assignSelf", "assignSelf(uint256):(uint8)", [
      ethereum.Value.fromUnsignedBigInt(taskId)
    ]);
  ...
  try_assignSelf(taskId: BigInt): ethereum.CallResult<i32> {
    let result = super.tryCall("assignSelf", "assignSelf(uint256):(uint8)", [
      ethereum.Value.fromUnsignedBigInt(taskId)
    ]);
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  unassignSelf(taskId: BigInt): i32 {
    let result = super.call("unassignSelf", "unassignSelf(uint256):(uint8)", [
      ethereum.Value.fromUnsignedBigInt(taskId)
    ]);
  ...
  try_unassignSelf(taskId: BigInt): ethereum.CallResult<i32> {
    let result = super.tryCall(
      "unassignSelf",
      "unassignSelf(uint256):(uint8)",
      [ethereum.Value.fromUnsignedBigInt(taskId)]
    );
    if (result.reverted) {
      return new ethereum.CallResult();
  ...
  getTaskIds(orgId: BigInt, from: BigInt, to: BigInt): Array<BigInt> {
    let result = super.call(
      "getTaskIds",
      "getTaskIds(uint256,uint256,uint256):(uint256[])",
      [
        ethereum.Value.fromUnsignedBigInt(orgId),
